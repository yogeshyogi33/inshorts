...
public class SlidingFragment extends Fragment {
    ...
    private void populateData(){
        ...
        try {
            ...
            ((TextView) getView().findViewById(R.id.hdline)).setText(hdline);
            ((TextView) getView().findViewById(R.id.reportby)).setText(reportedBy);
            ((TextView) getView().findViewById(R.id.moreat)).setText(moreAt);
